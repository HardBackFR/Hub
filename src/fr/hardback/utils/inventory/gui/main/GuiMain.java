...
public class GuiMain extends AbstractGui {
    ...
    public void display(){
        ...
        inventory.setItem(48, new ItemBuilder(Material.LEGACY_SKULL_ITEM, 1, (byte) 3).setSkullOwner(this.getPlayer().getName()).setName(ChatColor.AQUA + "Profil").setLore(Collections.singletonList(ChatColor.GRAY + "Cliquer pour accéder à votre profil")).toItemStack());
        ...
        inventory.setItem(43, new ItemBuilder(Material.MINECART).setName(ChatColor.AQUA + "Paramétres").setLore(Collections.singletonList(ChatColor.GRAY + "Cliquer pour accéder à vos paramétres")).toItemStack());
